...
|--------|--------------------------------|------------------------------------------------|
| **Career & Work** | Natural Leader; Ambitious; Inspires others | Score: 0.42 → “Smart & Practical”<br>Aptitude: Coding<br>Behavior: Routine & Regular<br>Career: Logistics / Operations |
| **Wealth & Finance** | Adventurous; Risk-taker; Desires richness | Score: 0.33 → “Safety & Secure”<br>Mindset: “A bird in hand is worth two in a bush” |
| **Social & Relationships** | Charming; Humanitarian; Emotionally aware | Score: 0.36 → “Introvert & Reticent”<br>Tendency: Withdraws from conflict, struggles to articulate |
...
```mermaid
flowchart TD
  A["🌍 World 1: Natural Leader"]:::good --> B["⚡ Conflict Zone"]:::warn
  B --> C["💻 World 2: Routine Executor"]:::neutral
  B --> D["🧠 Integration via Self-Awareness (0.65)"]:::focus
  D --> E["🚀 Aligned Executor → Conscious Leader"]:::goal

  classDef good fill:#4CAF50,stroke:#2E7D32,color:#fff;
  classDef warn fill:#FFB300,stroke:#E65100,color:#000;
  classDef neutral fill:#90A4AE,stroke:#455A64,color:#fff;
